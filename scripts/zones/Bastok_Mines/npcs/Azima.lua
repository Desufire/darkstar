...
function onTrigger(player,npc)
    ...
    local SkillLevel = player:getSkillLevel(SKILL_ALC);
    local Cost = getAdvImageSupportCost(player,SKILL_ALC);
...
--printf("RESULT: %u",option);
    ...
    if (csid == 0x007A and option == 1) then
        ...
        player:addStatusEffect(EFFECT_ALCHEMY_IMAGERY,15,0,480);
    end
end;