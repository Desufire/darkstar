...
RELIC_3RD_UPGRADE_WAIT_TIME = 7200;      -- wait time for 3rd relic upgrade (stage 3 -> stage 4) in seconds. 295200s = 82 hours.
...
ENHANCING_SONG_DURATION = 240; -- duration of enhancing bard songs such as Minuets, Ballads, etc.
